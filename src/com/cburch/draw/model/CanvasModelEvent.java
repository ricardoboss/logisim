...
public class CanvasModelEvent extends EventObject {
	...
	private static final int ACTION_ADDED = 0;
	private static final int ACTION_TRANSLATED = 2;
	private static final int ACTION_REORDERED = 3;
	private static final int ACTION_HANDLE_INSERTED = 5;
	private static final int ACTION_ATTRIBUTES_CHANGED = 7;
	private static final int ACTION_TEXT_CHANGED = 8;
